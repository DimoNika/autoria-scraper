...
Revision ID: 0ec288187fb0
Revises: 
Create Date: 2025-12-16 17:45:53.711854
...
def upgrade() -> None:
    ...
    sa.Column('car_vin', sa.String(length=100), nullable=False),
    sa.Column('car_number', sa.String(length=100), nullable=False),
    sa.Column('datetime_found', sa.DateTime(), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('url')
    )
    op.create_table('url_queue',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('url', sa.String(length=1000), nullable=False),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('url')
